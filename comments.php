 ...
 * handled by a callback to mixt_comment() which is
...
?>
	...
	<?php if ( have_comments() ) : ?>
		<header class="page-header">
			<h2 class="comments-title">
				<?php
					printf( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'mixt' ),
		...
		<ol class="comment-list media-list">
			<?php
				 ...
				 * See mixt_comment() in inc/template-tags.php for more.
				 */
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'mixt' ); ?></p>
	<?php endif; ?>
