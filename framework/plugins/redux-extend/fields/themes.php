...
// COLORS
$this->sections[] = array(
	'title'      => esc_html__( 'Colors', 'mixt' ),
	'desc'       => esc_html__( 'Create and manage custom colors and themes.', 'mixt' ),
	'icon'       => 'el-icon-leaf',
	'customizer' => false,
	'fields'     => array(
		...
		// Element Colors
		array(
			'id'       => 'custom-elem-colors',
			'type'     => 'mixt_multi_input',
			'title'    => esc_html__( 'Element Colors', 'mixt' ),
			'sortable' => true,
			'no_ajax'  => true,
			'add_text' => esc_html__( 'New Color', 'mixt' ),
			'inputs'   => array(
				...
				'name' => array(
					'type'       => 'group-id',
					'icon'       => 'el-icon-brush',
					'label'      => esc_html__( 'Name', 'mixt' ),
					'wrap_class' => 'color-name',
				),

				// Color Value
				'value' => array(
					'type'  => 'color',
					'label' => esc_html__( 'Color', 'mixt' ),
					'wrap_class' => 'color-value',
				),
			),
		),
		...
		// Button Colors
		array(
			'id'       => 'custom-btn-colors',
			'type'     => 'mixt_multi_input',
			'title'    => esc_html__( 'Button Colors', 'mixt' ),
			'sortable' => true,
			'no_ajax'  => true,
			'add_text' => esc_html__( 'New Color', 'mixt' ),
			'inputs'   => array(
