        ...
        class Redux_MIXT_config {
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id'       => 'theme-dev-mode',
                            'type'     => 'switch',
                            'title'    => __( 'Theme Dev Mode', 'redux-framework-demo' ),
                            'subtitle' => __( 'Load source JS files instead of concatenated and minified ones', 'redux-framework-demo' ),
                            'default'  => false,
                            'on'       => 'Yes',
                            'off'      => 'No'
                        ),
                        array(
                            'id'       => 'page-loader',
                            'type'     => 'switch',
                            'title'    => __( 'Show Loader', 'redux-framework-demo' ),
                            'subtitle' => __( 'Enable page load animations', 'redux-framework-demo' ),
                            'default'  => true,
                            'on'       => 'Yes',
                            'off'      => 'No'
                        ),
                        array(
                            'id'       => 'background-type',
                            'type'     => 'button_set',
                            'title'    => __( 'Site Background', 'redux-framework-demo' ),
                            'subtitle' => __('Background color, image or both', 'redux-framework-demo'),
                            'options'  => array(
                                '1' => 'Color',
                                '2' => 'Image',
                                '3' => 'Both'
                        ...
                        array(
                            ...
                            'subtitle' => __('The site&#39;s background color (default: #FFF).', 'redux-framework-demo'),
                        ...
                        array(
                            ...
                            'type'     => 'image_select',
                            'title'    => __('Background Pattern', 'redux-framework-demo'), 
                            'subtitle' => __('The site&#39;s background pattern', 'redux-framework-demo'),
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            'id'       => 'show-admin-bar',
                            'type'     => 'switch',
                            'title'    => __( 'Show WP Admin Bar', 'redux-framework-demo' ),
                            'default'  => true,
                            'on'       => 'Yes',
                            'off'      => 'No'
                        ),
                        array(
                            'id'       => 'show-masthead',
                            'type'     => 'switch',
                            'title'    => __( 'Show Masthead', 'redux-framework-demo' ),
                            'default'  => false,
                            'on'       => 'Yes',
                            'off'      => 'No'
                        ),
                        array(
                            'id'       => 'nav-sticky',
                            'type'     => 'switch',
                            'title'    => __( 'Sticky Navbar', 'redux-framework-demo' ),
                            'subtitle' => __( 'Navbar scrolls with page', 'redux-framework-demo' ),
                            'default'  => true
                        ),
                        array(
                            'id'       => 'nav-scheme',
                            'type'     => 'switch',
                            'title'    => __( 'Navbar Color Scheme', 'redux-framework-demo' ),
                            'default'  => true,
                            'on'       => 'Light',
                            'off'      => 'Dark'
                        ),
                        array(
                            'id'       => 'nav-sub-scheme',
                            'type'     => 'switch',
                            'title'    => __( 'Navbar Menu Color Scheme', 'redux-framework-demo' ),
                            'default'  => true,
                            'on'       => 'Light',
                            'off'      => 'Dark'
                        ),
                        array(
                            'id'       => 'nav-menu-icons',
                            'type'     => 'switch',
                            'title'    => __( 'Show Menu Icons', 'redux-framework-demo' ),
                            'default'  => true,
                            'on'       => 'Yes',
                            'off'      => 'No'
                        ),
                        array(
                            'id'       => 'nav-menu-arrows',
                            'type'     => 'switch',
                            'title'    => __( 'Show Menu Arrows', 'redux-framework-demo' ),
                            'default'  => true,
                            'on'       => 'Yes',
                            'off'      => 'No'
                        ),
                        ...
                        array(
                            ...
                            'title'    => __('Navbar Color', 'redux-framework-demo'),
                            'mode'     => 'background-color',
                            'validate' => 'color'
                        ),
                        array(
                            ...
                            'type'     => 'color',
                            'compiler' => array('#top-nav'),
                            'title'    => __('Navbar Border Color', 'redux-framework-demo'),
                            'mode'     => 'border-color',
                            'validate' => 'color'
                        ),
                    ),
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'menu_title'           => __( 'MIXT', 'redux-framework-demo' ),
                    'page_title'           => __( 'MIXT Options', 'redux-framework-demo' ),
