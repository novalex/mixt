    ...
    if ( ! class_exists( 'ReduxFramework_image_select' ) ) {
        ...
        class ReduxFramework_image_select {
            ...
            public function render() {
                ...
                if ( ! empty( $this->field['options'] ) ) {
                    ...
                    foreach ( $this->field['options'] as $k => $v ) {
                        ...
                        echo '<input type="radio" class="' . $this->field['class'] . '" id="' . $this->field['id'] . '_' . ( array_search( $k, array_keys( $this->field['options'] ) ) + 1 ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" value="' . $v['img'] . '" ' . checked( $this->value, $theValue, false ) . $presets . '/>';
                        if ( ! empty( $this->field['tiles'] ) && $this->field['tiles'] == true ) {
            ...
            public function enqueue() {
                ...
                $file_url = get_stylesheet_directory_uri() . '/framework/redux-mixt-extension-loader/extensions/image_select/image_select';
                ...
                wp_enqueue_style(
                    ...
                    $file_url . '/field_image_select.css',
                    time(),
                    true
                );
            }
