			...
			<div class="media-body">
				<div class="media-body-wrap panel panel-default">
					...
					<div class="panel-heading">
						<h5 class="media-heading"><?php printf( __( '%s <span class="says">says:</span>', 'mixt' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?></h5>
						<div class="comment-meta">
							...
							<?php edit_comment_link( __( '<span style="margin-left: 5px;" class="glyphicon glyphicon-edit"></span> Edit', 'mixt' ), '<span class="edit-link">', '</span>' ); ?>
						</div>
					</div>
...
endif; // ends check for mixt_comment()

if ( ! function_exists( 'mixt_the_attached_image' ) ) :
/**
...
if ( ! function_exists( 'mixt_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
	function mixt_posted_on( $echo = true ) {
		...
		if ( $echo ) {
			printf( __( '<span class="posted-on">%1$s</span><span class="byline"> by %2$s</span>', 'mixt' ),
				...
				sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
					...
					esc_attr( sprintf( __( 'View all posts by %s', 'mixt' ), get_the_author() ) ),
					esc_html( get_the_author() )
				)
			);
		} else {
			$post_meta = sprintf( __( '<span class="posted-on">%1$s</span><span class="byline"> by %2$s</span>', 'mixt' ),
				$time_string,
				sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
					esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
					esc_attr( sprintf( __( 'View all posts by %s', 'mixt' ), get_the_author() ) ),
