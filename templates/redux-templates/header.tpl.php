...
<div id="redux-header">
	...
	<div class="redux-action_bar">
		...
		<?php if ( false === $this->parent->args['hide_reset'] ) : ?>
			<?php submit_button( __( 'Reset Section', 'mixt' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false ); ?>
			<?php // submit_button( __( 'Reset All', 'mixt' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false ); ?>
		<?php endif; ?>
	</div>
