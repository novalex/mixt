...
if ( $attachment_ids ) {
	...
	<ul class="thumbnails <?php echo 'columns-' . $columns; ?>"><?php
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			echo "<li class='mixt-image'><div class='image-wrap $style'>";
				echo apply_filters(
						'woocommerce_single_product_image_thumbnail_html',
						sprintf( '<a href="%1$s" data-src="%1$s" class="product-gallery-thumb %2$s" title="%3$s">%4$s</a>', $image_link, $image_class, $image_caption, $image ),
